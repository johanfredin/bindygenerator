 ...
 * @property integerType the field type to use for integers
 * @property decimalType the field type to use for decimals
 * @property stringType the field type to use for strings
