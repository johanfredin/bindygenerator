...
class BindyGeneratorTest {
    ...
    private var generator: BindyGenerator
    private var expectedWithColumns: Path
    private var expectedWitoutColumns: Path
    private var javaSourceFilePath: Path
    private var javaSourceFilePath_NoColumns: Path

    private constructor(generator: BindyGenerator, expectedWithColumns: Path, expectedWitoutColumns: Path, javaSourceFilePath: Path, javaSourceFilePath_NoColumns: Path) {
        this.generator = generator
        this.expectedWithColumns = expectedWithColumns
        this.expectedWitoutColumns = expectedWitoutColumns
        this.javaSourceFilePath = javaSourceFilePath
        this.javaSourceFilePath_NoColumns = javaSourceFilePath_NoColumns
    }
    ...
    fun testGenerate_NoColumnNames() {
        this.generator.generatorConfig = getConfig(";", "Jonsson", FieldMapping.LOWER_CAMEL_CASE, true, true, false, false)

        this.generator.javaSourceFilePath = javaSourceFilePath_NoColumns
        this.generator.generate()
    ...
    fun getFieldMapFromFile_hasHeader_useNumericFieldValues_ObjectTypes() {
        this.generator.generatorConfig =
    ...
    fun testFieldMapFromFile_noHeader_UseNumericFieldValues_PrimitiveTypes() {
        this.generator.generatorConfig =
                getConfig(";", "Jonsson", FieldMapping.AS_IS,
                        isHeader = false, useNumericFieldTypes = true, usePrimitiveTypesWherePossible = true, includeColumnName = true)
